...
class CursoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cursos.index')->with('cursos',$cursos)->withInput($request->all());
    }
...
/*
        $fecha_inicio = date("Y-m-d H:i:s", strtotime($request->input('fecha_incio')));
        $fecha_fin = date("Y-m-d H:i:s", strtotime($request->input('fecha_fin')));    


        if(!($fecha_fin > $fecha_inicio)){
            if($fecha_fin == $fecha_inicio){
                return "error: fecha de inicio igual a fecha fin";
            }else{
                return "error: fecha de inicio superior a fecha fin";
            }
        }*/
