				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-12" style="max-height: 400px; overflow-y: scroll; ">
							...
							<div class="col-md-4">								
								<input type="checkbox" name="puestos[]" value="{{$puesto->id}}" class="checkbox_simple" {{ (count($curso->puestos->pluck('id')->toArray()) > 0) ? (in_array($puesto->id, $curso->puestos->pluck('id')->toArray()))? 'checked' : '' : ''}}>
