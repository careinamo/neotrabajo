...
<html lang="en">
  <head>
    ...
    <title>Axencia.. @yield('title_pestaña')</title>
    <!-- Icons-->
    ...
    <link rel="stylesheet" href="{{ asset('node_modules/datepicker/datepicker3.css') }}">
    <link rel="stylesheet" href="{{ asset('node_modules/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}">
    <link rel="stylesheet" href="{{ asset('node_modules/timepicker/bootstrap-timepicker.min.css') }}">
    
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('node_modules/iCheck/all.css') }}">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('src/img/brand/logo.svg') }}" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ asset('src/img/brand/sygnet.svg') }}" width="30" height="30" alt="CoreUI Logo">
      </a>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
               <a class="nav-link" href="{{url('ofertas')}}">
                 <i class="nav-icon icon-speedometer"></i> Ofertas
                 <span class="badge badge-primary">Nuevo</span>
               </a>
             </li>
             ...
             <li class="nav-item">
                <a class="nav-link" href="{{url('empresas')}}">
                  <i class="nav-icon icon-speedometer"></i> Empresas
                  <span class="badge badge-primary">Nuevo</span>
                </a>
              </li>
          </ul>
