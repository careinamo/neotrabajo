...
@section('breadcrumb')
          ...
          <li class="breadcrumb-item active">Validacion de Oferta</li>
@endsection
...
@if($oferta->validada != true)	
<form method="POST" action="{{url('ofertas/'.$oferta->id.'/validar')}}" accept-charset="UTF-8" >
{{ csrf_field() }}
@else
<form method="GET" action="{{url('ofertas')}}" accept-charset="UTF-8" >
@endif
    <div class="row">
	    <div class="col-md-12">
			    <div class="card">
					<div class="card-header">
						<i class="icon-note"></i> Validar Oferta
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">								
								...
								<div class="form-group">
									...
									<input type="text" disabled="" class="form-control" name="descripcion" value="{{ $oferta->descripcion }}">
								</div>
								<div class="form-group">
									<label>Descripcion Larga:</label>
									<input type="text" disabled="" class="form-control" name="descripcion_larga" value="{{ $oferta->descripcion_larga }}">
								</div>
								<div class="form-group">
					...
					<div class="card-footer">
						<div class="float-right mr-3">
							@if($oferta->validada != true)	
								<button type="submit" class="btn btn-primary">Validar Oferta</button>
							{{ csrf_field() }}
							@else
								<button type="submit" class="btn btn-primary" disabled="">Oferta ya validada</button>
							@endif
						</div>		
					</div>
				</div>
